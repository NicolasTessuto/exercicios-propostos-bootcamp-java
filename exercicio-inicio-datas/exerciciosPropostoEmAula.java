...
public class exerciciosPropostoEmAula {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        Date dataDeNascimento = new Date(619488794500L); //Data aproximada em millis do meu tempo de vida
        Date dataComparativa = new Date(354155460000L); //Data aproximada em millis de 15/05/2010


        boolean testeDeVerificacao = (dataDeNascimento.after(dataComparativa));
        if(testeDeVerificacao == true){
            System.out.println("Voce nasceu DEPOIS do dia 15/05/2010");
        }
        else{
            System.out.println("Voce nasceu ANTES do dia 15/05/2010");
        }
